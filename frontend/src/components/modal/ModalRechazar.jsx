...
function ModalRechazar(props) {
  return (
    <div class="modal fade text-white" data-bs-theme="dark" id="RechazarModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
